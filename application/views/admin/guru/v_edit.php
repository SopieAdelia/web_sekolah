		...
		<div class="panel-body">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input class="form-control" value="<?= $guru->tngl_lahir ?>" type="text" name="tngl_lahir" id="tanggal" placeholder="Tanggal lahir" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<input type="file" class="form-control" name="foto_guru" placeholder="foto_guru">
			</div>
