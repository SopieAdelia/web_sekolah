					...
					foreach ($gallery as $key => $value) { ?>
						<tr>
							...
							<td>
								...
								<a href="<?= base_url('gallery/delete/' . $value->id_gallery) ?>" onclick="return confirm('Apakah data ini akan di hapus..?')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
